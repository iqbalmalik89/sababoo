...
-->
                                ...
                                <input id="id" name="id" type="hidden" class="form-control" value="<?php echo $tradesman->id;?>"/>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group mb-20 bootstrap3-wysihtml5-wrapper">
                                        <label for="dynamicAddForm_#index#_extraInfo">Background:</label>
                                        <textarea id="summary" name="summary" class="form-control" rows="5"><?php if(isset($tradesman->background)){ echo $tradesman->background;}?></textarea>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#update_basic_info').click(function () {
            $('.loader').show();
            html = '';
            pageURI = '/tradesman/update_basic_info';
