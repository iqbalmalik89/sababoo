        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <a href="{{URL::to('admin/disputes')}}">Job Disputes</a>
            ...
            <!-- BEGIN PAGE TITLE-->
            <div>
                <h3 class="page-title pull-left"> Job Disputes
                    <small>(<span id="total_disputes"></span>)</small>
                </h3>
                <div class="pull-right margin-top-25px">
                    <div>
                        <!-- <label>Search: <input type="search" class="form-control input-sm input-small input-inline" placeholder="" aria-controls="sample_2" id="dispute_search_keyword"></label> -->

                        <div class="form-actions margin-left-10px pull-right">
                            <a href="javascript:;" id="dispute_filter_date_btn"><button class="btn green" type="button">Go<i class="fa fa-arrow-right fa-fw"></i> </button></a>
                        </div> 

                        <div class=" margin-left-10px pull-right">
                            <select id="disputes_filter_by_status" class="bs-select form-control">
            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            <thead id="disputes_list_head">
                                
                            </thead>
                            <tbody id="disputes_list">
                ...
                <div class="table_pagintaion clearfix">
                    ...
                    <div class="pull-right general-limit-div">
                        <form>
                            <div class="">
                                <select class="bs-select form-control" id="dispute-list-limit">
                                    <option value="5">Show 5 disputes per page</option>
                                    <option value="10" selected="selected">Show 10 disputes per page</option>
                                    <option value="15">Show 15 disputes per page</option>
                                    <option value="20">Show 20 disputes per page</option>
                                </select>
                            </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Are you sure you want to <span id="update_status_text"></span> this dispute?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
        <a href="javascript:;" id="dispute_status_btn"><button type="button" class="btn green">Yes</button></a>
...
<input type="hidden" value="0" id="hidden_action_dispute_id"/>
<input type="hidden" value="0" id="hidden_action_dispute_status"/>
