...
<div class="col-sm-12">
    ...
    <div class="form-group bootstrap3-wysihtml5-wrapper mb-20">
        ...
        <textarea class="bootstrap3-wysihtml5 form-control" id="interests" name="interests" style="height: 200px;">{{$tradesman->interests}}</textarea>
    </div>



    <div id="dynamicAddForm3_controls" class="dynamic-add-form-action">
        <div id="dynamicAddForm3_add"><a onclick="saveInterests();" class="btn btn-primary btn-sm"><span>Save</span></a></div>
    </div>
