...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <input type="hidden" id="recover_password_key" value="{{$code}}"/>
    ...
    ?>
        <form class="login-form">
            <h3 class="form-title font-green">Recover Password</h3>
            <div class="msg_divs alert" id="user-reset-error-msg"></div>
            ...
            <div class="form-actions">
                <a href="javascript:;" id="reset_btn"><button type="button" class="btn green">Submit</button></a>
                <img class="button_spinners" src="{{URL::to('pannel/images/loader.gif')}}" id="reset_submit_loader">
            </div>
        </form>
    <?php
        }
