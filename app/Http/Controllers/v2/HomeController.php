...
class HomeController extends Controller
{
    ...
    public function showHome()
    {
        ...
        if($this->logged_user->role=="employee"){
            ...
            return redirect("v2/employee/view/".$employee[0]->id);
            ...
            return redirect("v2/employer/view/".$employer->id);
            ...
            $education = Education::where(array('userid'=> $this->logged_user->id))->get();
            $certification = Certification::where(array('userid'=> $this->logged_user->id))->get();
            return redirect("v2/tradesman/view/".$tradesman->id);
    ...
    public function showLogin()
    {
        ...
        return view('frontend.v2.auth.login', ['sticky_footer'=>'sticky-footer']);
    }
    ...
    public function showSignup()
    {
        ...
        return view('frontend.v2.auth.signup', ['sticky_footer'=>'sticky-footer']);
    }
